...
class AppTextStyles {
  ...
  // Micro — dense technical display (data table type annotations, stack traces)
  static const TextStyle micro = TextStyle(fontSize: 8, fontWeight: FontWeight.w400, height: 1.5);
