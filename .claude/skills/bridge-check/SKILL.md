...
1. `packages/sdui/lib/src/theme/sdui_theme.dart`
2. `packages/sdui/lib/src/registry/builtin_widgets.dart`
3. `packages/sdui/lib/src/registry/behavior_widgets.dart`
4. `packages/sdui/lib/src/registry/widget_registry.dart` (loadCatalog method)
5. `.claude/skills/phase-4-catalog/SKILL.md`
6. `.claude/skills/phase-4-catalog/integrate-window.md`
7. `.claude/skills/phase-4-catalog/integrate-header.md`
8. `.claude/skills/phase-5-review/checks-catalog.md`
...
Run `cd packages/sdui && dart analyze lib/`. **FAIL** if any errors (warnings/infos are noted but not failures).
...
Save report to `_local/bridge-report.md`.
