...
1. **Approved HTML mock** — `packages/tercen_ui_widgets/widgets/{name}/_mock/styled.html`
2. **Functional spec** — `packages/tercen_ui_widgets/widgets/{name}/{name}-spec.md`
...
Output to `packages/tercen_ui_widgets/widgets/{name}/_mock/design-decisions.md`:
...
- `packages/tercen_ui_widgets/widgets/{name}/_mock/design-decisions.md` — ALWAYS produced
- `packages/tercen_ui_widgets/widgets/{name}/{name}-spec.md` — updated only if >5 decisions
