...
- **Target directory:** `packages/tercen_ui_widgets/widgets/${ARGUMENTS}/`
...
- `packages/tercen_ui_widgets/widgets/${ARGUMENTS}/`
- `packages/tercen_ui_widgets/widgets/${ARGUMENTS}/_mock/`
- `packages/tercen_ui_widgets/widgets/${ARGUMENTS}/_fixtures/`
- `_issues/` (if not exists)
- `_local/` (if not exists)

### 5. Create spec placeholder
Create `packages/tercen_ui_widgets/widgets/${ARGUMENTS}/${ARGUMENTS}-spec.md`:
```markdown
...
> 1. Add beginning materials to `packages/tercen_ui_widgets/widgets/${ARGUMENTS}/` — screenshots, data files, existing code, documentation.
